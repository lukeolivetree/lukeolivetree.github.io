...
*/
$( function() {
        var startDate = "September  22, 2021 13:44:37";

        $('.countdown.simple').countdown({ date: startDate });

        $('.countdown.styled').countdown({
          date: startDate,
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 2) + " <span>days</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>hrs</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>min</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>sec</span></div><span><h3>loafing around...</h3></span>");
          }
        });
...
$('document').ready(function () {
	 $.backstretch([
      "images/img1-blur.jpg"
    , "images/img2-blur.jpg"
    , "images/img3-blur.jpg"
